...
export default function MyDrawer({navigation}) {
  const GoToSettings = () => {
    ...
    console.log('I Naviate to settings');
  };

  return (
    <GoToSettingsContext.Provider value={GoToSettings}>
      <Drawer.Navigator
